...
impl Color {
    ...
    pub fn to_css_oklab(&self) -> impl fmt::Display + fmt::Debug + '_ {
        let [l, a, b, alpha] = self.to_oklaba();
        let l = FloatFmt(l);
        let a = FloatFmt(a);
        let b = FloatFmt(b);
    ...
    pub fn to_css_oklch(&self) -> impl fmt::Display + fmt::Debug + '_ {
    ...
    pub fn to_css_lab(&self) -> impl fmt::Display + fmt::Debug + '_ {
        let [l, a, b, alpha] = self.to_laba();
        let l = FloatFmt(l);
        let a = FloatFmt(a);
        let b = FloatFmt(b);
