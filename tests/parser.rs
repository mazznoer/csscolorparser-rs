...
fn equal() {
    let test_data = [
        ...
        ("hwb(290 30% 0%)", "hwb(290 30 0)"),
        ("hsl(180,50%,27%)", "hsl(180,50,27)"),
        // A bare <number> is on the 0..100 scale and equals the same value with `%`.
